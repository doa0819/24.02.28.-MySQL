...
-- not null 은 무조건 써야 하는 값 아닌 곳은 써도 되고 안해도 되는 값
...
(2, 'user02', 'pass02', '유관순', '여', '010-5642-5486', 'yul123@gmail.com');
...
create table if not exists user_primary(  -- 소괄호  안 : 테이블 레벨 
	-- user_no int primary key ,    -- 하나하나가 컬럼레벨
	user_no int,    -- 하나하나가 컬럼레벨
    user_id varchar(255) not null,
    user_pwd varchar(255) not null,
    user_name varchar(255) not null,
    gender varchar(3),
...
values
(3, 'user03', 'pass03', '유관순1', '여', '010-5642-5486', 'yul123@gmail.com',10),
(4, 'user04', 'pass04', '유관순2', '여', '010-5642-5486', 'yul123@gmail.com',20);
...
(user_no, user_id, user_pwd, user_name, gender, phone, email, grade_code)
values
(5, 'user05', 'pass05', '유관순3', '여', '010-5642-5486', 'yul123@gmail.com',50);
-- 50은 select * from user_grade; 50이라는 값이 없어서 안된다.

-- check 
-- change 제약 조건 : 위반 시 허용하지 않는다.
...
create table if not exists tbl_country(
    ...
    add_time date default (current_time)
 )engine=InnoDB;
